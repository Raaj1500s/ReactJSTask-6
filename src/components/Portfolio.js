...
class portfolio extends Component{
    render(){
        const imageUrl = process.env.PUBLIC_URL + '/My Image.jpeg';
        return(
            <div class="container">
                    ...
                    <div class="col-md-8">
                        <div class="jumbotron jumbotron-fluid mt-5 bg-secondary border rounded">
                            <div class="container1 border border-secondary rounded">
                                ...
                                <p class="p-2 one">
                                I am Kondeti Raja Manikanta. Computer Science Student passionate to work in a competitive environment where I can showcase my
                                technical skills. </p>
                            </div>
                        </div>
                        ...
                        <div class="jumbotron jumbotron-fluid mt-1 bg-secondary border rounded">
                            <div class="container1 border border-secondary rounded">
                                ...
                                <p class="p-1 one">
                                    <ul>
                                        <li>Playing Cricket,VolleyBall</li>
                        ...
                        <div class="jumbotron jumbotron-fluid mt-1 bg-secondary border rounded">
                            <div class="container1 border border-secondary rounded">
                                <h3 class="p-2">Contact Me: <a href="mailto:mr.k.manikanta99@gmail.com">Email</a> <a href="LinkedInProfile">LinkedIn</a> +91 9505817039</h3>
                            </div>
                        </div>
                    </div>
                </div>
